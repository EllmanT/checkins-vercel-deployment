...
import VisitsDailyLineChart from "component/deliverer/displayCharts/VisitsDailyLineChart";
const handlePrint = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Box display="flex">
        ...
        <Header
          title="DAILY WALK-IN INFO"
          subtitle="Chart of daily walkins"
        />
      </Box>
      <Button
        variant="outlined"
...
export default DailyVisitsPage;
