...
const OverviewVisitsChart = ({ isDashboard = false, view }) => {
  ...
  const [formattedData] = useMemo(() => {
    ...
    const totalVisitLine = {
      id: "totalVisit",
      color: theme.palette.secondary.main,
      data: [],
    };
    const totalPendingLine = {
      id: "totalPending",
    ...
    Object.values(monthlyData).forEach(
      ({ month, totalVisits, totalPending, totalAssisted }) => {
        ...
        totalVisitLine.data = [
          ...totalVisitLine.data,
          { x: shortMonth, y: totalVisits },
        ];
        totalAssistedLine.data = [
          ...totalAssistedLine.data,
          { x: shortMonth, y: totalAssisted },
        ];
        totalPendingLine.data = [
          ...totalPendingLine.data,
          { x: shortMonth, y: totalPending },
        ];
      }
    );
...
export default OverviewVisitsChart;
